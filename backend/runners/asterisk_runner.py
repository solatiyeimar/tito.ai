...
def parse_args():
    ...
    parser.add_argument("-m", "--llm-model", type=str, help="LLM model name")

    # STT configuration
    parser.add_argument(
        "-s", "--stt-provider", type=str.lower, choices=["deepgram", "groq"], help="STT provider"
    )
    ...
    parser.add_argument("-v", "--tts-voice", type=str, help="TTS voice ID")
